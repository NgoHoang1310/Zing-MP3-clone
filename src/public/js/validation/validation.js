function Validator(options) {
    //lấy thẻ cha
      ...
      function validate(inputElement, rule) {
        ...
        var errorMessage;
        var getMessage = getParent(inputElement,options.formGroupSelector).querySelector(
      ...
      return {
        ...
        test: function (value) {
          return value.length >= min
            ? undefined
            : message || `Vui lòng nhập tối thiểu ${min} ký tự`;
        },
      };
    };
      ...
      return {
        ...
        test: function (value) {
          return value == getConfirmValue()
            ? undefined
            : message || "Dữ liệu nhập lại không chính xác";
        },
      };
    };
